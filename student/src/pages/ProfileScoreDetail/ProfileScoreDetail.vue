  ...
  export default {
    ...
    methods: {
      ...
      async getScoreReport(){
        ...
        console.log("获取成绩报告数据", result)
        if (result.obj.statu == 0){
          this.chartDataRingScore = result.obj.data.chartDataRingScore;
          this.chartDataBarCorrect = result.obj.data.chartDataBarCorrect;
          this.chartDataLineRanking = result.obj.data.chartDataLineRanking;
          this.chartDataPieTime = result.obj.data.chartDataPieTime;
          ...
          this.percentage = this.myScore/result.obj.data.totalScore*100;
