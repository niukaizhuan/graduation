    ...
    methods: {
      ...
      async getLanguageInfoById(){
        ...
        if (result.obj.statu == 0){
          this.languageInfoById = result.obj.data;
        }
        else {
          Toast({
      ...
      async getPapersInfo(){
        ...
        if (result.obj.statu == 0){
          this.papersInfo = result.obj.data;
          console.log("this.papersInfo ", this.papersInfo )
      ...
      async correctSearch(){
        ...
        let result = await reqPapersInfo({langId});
        if (result.obj.statu == 0){
          let papersInfo = result.obj.data;
          console.log("papersInfo", papersInfo)
