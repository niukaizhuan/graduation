  ...
  methods: {
    async getChartData(callback) {
      ...
      if (result.obj.statu === 0) {
        this.snoData = result.obj.data.snoData
        this.singleData = result.obj.data.singleData
        this.multipleData = result.obj.data.multipleData
        this.judgeData = result.obj.data.judgeData
        this.fillData = result.obj.data.fillData
        this.scoreData = result.obj.data.scoreData
        this.timeUsedData = result.obj.data.timeUsedData
