  ...
  methods: {
    async getList() {
      ...
      if (result.obj.statu === 0) {
        ...
        this.total = result.obj.data.fillList.length
        this.list = result.obj.data.fillList.filter((item, index) => index < this.listQuery.limit * this.listQuery.page && index >= this.listQuery.limit * (this.listQuery.page - 1))
      }
