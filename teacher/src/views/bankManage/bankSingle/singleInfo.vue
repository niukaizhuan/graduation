  ...
  methods: {
    async getList() {
      ...
      if (result.obj.statu === 0) {
        ...
        this.total = result.obj.data.singleList.length
        this.list = result.obj.data.singleList.filter((item, index) => index < this.listQuery.limit * this.listQuery.page && index >= this.listQuery.limit * (this.listQuery.page - 1))
      }
