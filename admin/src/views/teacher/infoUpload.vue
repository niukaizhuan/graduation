  ...
  methods: {
    ...
    async insertTeacherInfoList(teacherList) {
      ...
      if (result.obj.statu === 0) {
        ...
        this.tableData = result.obj.data.responseList
        this.allItemCount = result.obj.data.allItemCount
        this.successItemCount = result.obj.data.successItemCount
        this.failItemCount = result.obj.data.failItemCount
        this.$message({
