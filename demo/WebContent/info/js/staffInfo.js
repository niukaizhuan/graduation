var vStaffInfo = new Vue({
    ...
    data: function () {
        return {
            ...
            notice: '',// 提醒对象
            staffInfo: {
            	 id: '', staffName: '', staffCode: '', userId: '', birthday: '', sex: '',
                sexString:'',createdDate: '', stateDate: '', state: '',birthdayString:'',schoolNo:'',title:'',schoolName:''
            },// 实体类
            sStaffInfo: {
            	staffName: '',
            	staffCode: '',
    ...
    methods: {
        ...
        initPage() {
            // 生成表头
            this.column = [
                {title: '姓名', key: 'staffName', width: 150},//固定列
                {title: '编号', key: 'staffCode', width: 150},
                {title: '学院', key: 'schoolName', width: 150},//固定列
                {title: '职称', key: 'title', width: 150},
                {title: '出生年月', key: 'birthdayString', width: 150},
                {title: '性别', key: 'sexString', width: 150}
            ];
            // 添加文字提示
