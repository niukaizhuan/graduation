let vSchoolInfo = new Vue({
    ...
    data: function () {
        return {
            ...
            notice: '',// 提醒对象
            schoolInfo: {
                id: '', schoolName: '', remark: '', stateDate: '', state: '',schoolNo:'',
            },// 实体类
            sSchoolInfo: {
            	schoolName: '', remark: ''
            },// 搜索信息
    ...
    methods: {
        ...
        initPage() {
            ...
            this.column = [
                ...
                {title: '学院编码', key: 'schoolNo', width: 150},//固定列
            ];
            // 添加文字提示
        ...
        addSchoolInfo() {
            ...
            let data = {
                ...
                schoolNo: this.schoolInfo.schoolNo,
        ...
        openEditSchoolInfoModal(index) {
            ...
            this.schoolInfo.schoolNo = this.nowData[index].schoolNo;
