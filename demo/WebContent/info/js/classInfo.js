let vClassInfo = new Vue({
    ...
    data: function () {
        return {
            ...
            notice: '',// 提醒对象
            classInfo: {
                id: '', className: '', specialtyId: '', remark: '', createdDate: '',
                stateDate: '', state: '', classNo:'',studentNumber:'',
            },// 实体类
            sClassInfo: {
                className: '',
            },// 搜索信息
    ...
    methods: {
        ...
        initPage() {
            // 生成表头
            this.column = [
                {title: '班级名称', key: 'className', width: 150},//固定列
                {title: '班级编码', key: 'classNo', width: 150},//固定列
                {title: '班级人数', key: 'studentNumber', width: 150},//固定列
                {title: '专业名称', key: 'subjectName', width: 150},
                // {title: '年份', key: 'yearName', width: 150}
            ];
            // 添加文字提示
        ...
        addClassInfo() {
            ...
            let data = {
                ...
                studentNumber: this.classInfo.studentNumber,
        ...
        openEditClassInfoModal(index) {
            ...
            this.classInfo.classNo = this.nowData[index].classNo;
            this.classInfo.studentNumber = this.nowData[index].studentNumber;
            this.classInfo.remark = this.nowData[index].remark;
        ...
        clearClassInfo() {
            ...
            this.classInfo.classNo = '';
            this.classInfo.studentNumber = '';
