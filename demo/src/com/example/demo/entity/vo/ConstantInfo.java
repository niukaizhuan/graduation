...
public class ConstantInfo {
    public static final String IS_FIX = "is_fix";//是否固定
    public static final String COLLEGE_NO = "school_no";//学院编号
    public static final String CLASS_NO = "class_no";//班级编号
    public static final String TEACHER_NO = "staff_no";//教师编号
    public static final String COURSE_NO = "course_no";//课程编号
