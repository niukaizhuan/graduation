...
public class JWTUtil {
	...
	public static String createToken(JWTQuery query) {
		...
		claimsMap.put("userId", query.getUserId());
		claimsMap.put("userName", query.getUserName());
		claimsMap.put("role", query.getRole());
		claimsMap.put("menuNameList", query.getMenuNameList());
...
//				.setPayload(payload) // 有效载荷和主题二选一
		...
		System.out.println("完成生成"+builder.compact());
		// 完成生成
