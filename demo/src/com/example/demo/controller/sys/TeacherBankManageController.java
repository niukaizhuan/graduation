...
import com.example.demo.service.sys.TeacherBankManageService;
import com.example.demo.service.sys.TeacherPaperService;
import com.example.demo.util.sys.QiniuCloudUtil;
...
public class TeacherBankManageController {
	...
	public ServerResponse searchSingleList(@RequestParam("content") String content,
			@RequestParam("langId") Integer langId, @RequestParam("composeFlag") String composeFlag) {
	...
	public ServerResponse searchMultipleList(@RequestParam("content") String content,
			@RequestParam("langId") Integer langId, @RequestParam("composeFlag") String composeFlag) {
		List<Map<String, Object>> resultList = teacherBankManageService.searchMultipleList(content, langId,
				composeFlag);
