...
import com.example.demo.mapper.sys.StudentHomeRotationImgMapper;
...
public class AdminRotationImgServiceImpl implements AdminRotationImgService {
	...
	public List<Map<String, Object>> getRotationImgsList() {
		...
		List<StudentHomeRotationImg> studentHomeRotationImgList = studentHomeRotationImgMapper
				.selectByExample(studentHomeRotationImgExample);
